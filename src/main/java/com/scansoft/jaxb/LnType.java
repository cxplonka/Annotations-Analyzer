...
/**
 * <p>Java-Klasse für lnType complex type.
 * 
 ...
 *       &lt;attribute name="forcedEOF" type="{http://www.w3.org/2001/XMLSchema}boolean" default="false" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class LnType {
    ...
    @XmlAttribute(name = "forcedEOF")
    protected Boolean forcedEOF;
    ...
    /**
     * Ruft den Wert der forcedEOF-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
    ...
    /**
     * Legt den Wert der forcedEOF-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setForcedEOF(Boolean value) {
        this.forcedEOF = value;
    }
